...
public class ContinuousPatrolThreeWaypoints : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // In-place animation => we move the Transform ourselves
        animator.applyRootMotion = false;

        // Cache a base clip length (fallback if state info isn’t ready)
    ...
    {
        // Recompute remaining dynamically each sub-step
        while (true)
        {
            ...
            // Play anim from start on layer 0
            animator.Play(stateName, 0, 0f);
            yield return null; // allow animator to update state info
            ...
            // Distance for this step (don’t overshoot waypoint)
